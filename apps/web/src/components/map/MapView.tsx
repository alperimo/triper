...
export function MapView({
  ...
  return (
    <div className="relative w-full" style={{ height }}>
      ...
      {/* Map overlay UI */}
      <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md text-white px-4 py-2 rounded-lg shadow-xl pointer-events-none">
        <div className="flex items-center gap-2">
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
          </svg>
          <span className="text-sm font-medium">Privacy-Preserving Matches</span>
        </div>
        <p className="text-xs text-white/70 mt-1">
          {encryptedAuras.length} potential companions nearby
        </p>
        <p className="text-xs text-white/50 mt-1">
          Locations are blurred using H3 cells
        </p>
      </div>
    </div>
  );
